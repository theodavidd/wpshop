...
<p><strong><?php esc_html_e( 'Payment method', 'wpshop' ); ?></strong> : <?php echo empty( $proposal->data['payment_method'] ) ? 'N/D' : Payment::g()->get_payment_title( $proposal->data['payment_method'] ); ?></p>
<p>
	<strong><?php esc_html_e( 'Payment status', 'wpshop' ); ?></strong> :
	<span>
	<?php
	echo esc_html( Payment::g()->convert_status( $proposal->data ) );
