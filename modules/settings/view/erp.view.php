...
<form class="wpeo-form wpeo-grid grid-2 grid-padding-1" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="POST">
	...
	<div class="form-element">
		<span class="form-label"><?php esc_html_e( 'Dolibarr Products Lists', 'wpshop' ); ?></span>
		<label class="form-field-container">
	...
	<div class="form-element">
		<span class="form-label"><?php esc_html_e( 'Dolibarr Tiers Lists', 'wpshop' ); ?></span>
		<label class="form-field-container">
	...
	<div class="form-element">
		<span class="form-label"><?php esc_html_e( 'Dolibarr Orders Lists', 'wpshop' ); ?></span>
		<label class="form-field-container">
	...
	<div class="form-element">
		<span class="form-label"><?php esc_html_e( 'Dolibarr Proposals Lists', 'wpshop' ); ?></span>
		<label class="form-field-container">
	...
	<div class="form-element">
		<span class="form-label"><?php esc_html_e( 'Dolibarr Payments Lists', 'wpshop' ); ?></span>
		<label class="form-field-container">
	...
	<div class="form-element">
		<span class="form-label"><?php esc_html_e( 'Dolibarr Invoices Lists', 'wpshop' ); ?></span>
		<label class="form-field-container">
	...
	<div class="form-element">
		<span class="form-label"><?php esc_html_e( 'Dolibarr Create Product', 'wpshop' ); ?></span>
		<label class="form-field-container">
	...
	<div class="form-element">
		<span class="form-label"><?php esc_html_e( 'Dolibarr Create Tier', 'wpshop' ); ?></span>
		<label class="form-field-container">
	...
	<div class="form-element">
		<span class="form-label"><?php esc_html_e( 'Dolibarr Create Order', 'wpshop' ); ?></span>
		<label class="form-field-container">
	...
	<div class="form-element">
		<span class="form-label"><?php esc_html_e( 'Dolibarr Create Proposal', 'wpshop' ); ?></span>
		<label class="form-field-container">
