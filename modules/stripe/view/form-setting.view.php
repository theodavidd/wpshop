...
<form class="wpeo-form" action="<?php echo admin_url( 'admin-post.php' ); ?>" method="POST">
	...
	<div class="form-element bloc-activate">
		...
		<input type="hidden" name="activate" class="activate" value="<?php echo (int) 1 === (int) $stripe_options['active'] ? 'true' : 'false'; ?>" />
		<i style="font-size: 2em;" class="toggle fas fa-toggle-<?php echo $stripe_options['active'] ? 'on' : 'off'; ?>" data-bloc="bloc-activate" data-input="activate"></i>
	</div>
