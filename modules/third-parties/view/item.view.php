...
<div class="table-row">
	...
	<div class="table-cell table-200">
		...
		<ul class="reference-actions">
			...
			<?php if ( ! empty( $third_party->data['external_id'] ) ) : ?>
				<li><a href="<?php echo esc_attr( $doli_url ); ?>commande/card.php?id=<?php echo $third_party->data['external_id']; ?>" target="_blank"><?php esc_html_e( 'Edit in Dolibarr', 'wpshop' ); ?></a></li>
			<?php endif; ?>
		</ul>
	</div>
	...
	<?php do_action( 'wps_listing_table_end', $third_party, 'third-parties' ); ?>
