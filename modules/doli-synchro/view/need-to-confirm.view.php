		...
		<div class="modal-container">
			...
			?>
				...
				if ( $date_wp > $date_doli ) :
					...
					?>
					<h3>Les données du tier sont plus récentes de<strong style="font-weight: 700">
					<span>
						<?php
						...
						echo $interval->format('%imin'); ?> </strong> sur
				...
				elseif ( $date_wp < $date_doli ) :
					...
					<span>
						...
						echo $interval->format('%imin'); ?> </strong> sur <strong style="font-weight: 700">Dolibarr</strong>.
					</span>
				</h3>
					<?php
				else :
					?>
					<h3>Les données du tier sont identiques sur WordPress et Dolibarr</h3>
					<?php
				endif;
				?>
			</h3>
