		...
		if ( ! empty( $invoices ) ) :
			foreach ( $invoices as $invoice ) :
				...
				<tr>
					...
					<td data-title="View">
						<a target="_blank" href="<?php echo esc_attr( admin_url( 'admin-post.php?action=wps_download_invoice&_wpnonce=' . wp_create_nonce( 'download_invoice' ) . '&avoir=' . $order->data['avoir'] . '&order_id=' . $invoice->data['parent_id'] ) ); ?>" class="wpeo-button button-primary">
